...
var CONFIG = {
    ...
    indexHtmlTemplate: './FableReactionDemo/index.html',
    fsharpEntry: './FableReactionDemo/App.fs.js',
    cssEntry: './FableReactionDemo/style.scss',
    outputDir: './deploy',
    assetsDir: './FableReactionDemo/public',
